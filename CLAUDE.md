# brainstorm — instrucciones del proyecto
...
| App de Fly.io | `brainstorm-npiobject-labs` |
| Carpeta de Drive (id) | `1FithJGx3HLgPd9H-1VEgwxEfe90Yn1q6` |
...
El repositorio `npiobject-labs/brainstorm`, rama `main`, es la **única** fuente de verdad, tanto para el código como para la documentación de `docs/planificacion/`. Todo lo que importe vive aquí y se edita aquí.
...
| Qué | URL | Despliegue |
|---|---|---|
| Mock estático (Pages) | https://npiobject-labs.github.io/brainstorm/ | `.github/workflows/pages.yml` en push a `main` |
| Bitácora (Pages) | https://npiobject-labs.github.io/brainstorm/bitacora.html | idem; el índice lo genera `pages.yml` |
...
| Comprobación del backend (Pages) | https://npiobject-labs.github.io/brainstorm/holamundo.html | página estática que llama a `/holamundo` y `/salud` desde el navegador |
...
- Cada mock lleva `<meta name="build" content="BR-B1-AAAAMMDD-NNN">` con un número nuevo en cada iteración.
...
Si necesitas comprobar algo desde la sesión, hazlo contra la API de GitHub (`https://api.github.com/repos/npiobject-labs/brainstorm/actions/runs/...`), que sí es accesible.
...
Página pública: https://npiobject-labs.github.io/brainstorm/bitacora.html · formato en `docs/bitacora/README.md`.
